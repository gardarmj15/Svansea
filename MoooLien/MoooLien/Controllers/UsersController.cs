...
namespace MoooLien.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,name,authorization,username,password,SNN,email")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,name,authorization,username,password,SNN,email")] User user)
        {
            if (ModelState.IsValid)
            {
